	...
	<div id="leftcontainer" class="leftcontainer">
		...
		<div class="dragLayer" id="postwin">
			<div class="dragHeader">
				...
				<div style="float: right;">
					<label class="more" title="更多" onclick="openMDITab('<%=contextPath %>/erp/personal_work/company_anno.jsp')">
					</label>
				</div>
			</div>
		...
		<div class="dragLayer" id="noticewin">
			<div class="dragHeader">
				...
				<div style="float: right;">
					<label class="more" title="更多" onclick="openMDITab('<%=contextPath %>/erp/personal_work/company_notice.jsp')">
					</label>
				</div>
		...
		<div class="dragLayer" id="votewin">
			<div class="dragHeader">
				...
				<div style="float: right;">
					<label class="more" title="更多" onclick="openMDITab('<%=contextPath %>/erp/communication/vote_total_pager.jsp')">
					</label>
				</div>
			</div>
		...
		<div class="dragLayer" id="notewin">
			<div class="dragHeader">
				...
				<div style="float: right;">
					<label class="more" title="更多" onclick="openMDITab('<%=contextPath %>/erp/personal_work/company_adver.jsp')">
					</label>
				</div>
			</div>
	...
	<div id="middlecontainer" class="middlecontainer">
		...
		<div class="dragLayer" id="approvewin">
			<div class="dragHeader">
				...
				<div style="float: right;">
					<label class="more" title="更多" onclick="openMDITab('<%=contextPath %>/erp/personal_work/flow_todo.jsp')">
					</label>
				</div>
			</div>
		...
		<div class="dragLayer" id="schwin">
			<div class="dragHeader">
				...
				<div style="float: right;">
					<label class="more" title="更多" onclick="openMDITab('<%=contextPath %>/erp/work_arrange/workCalender.jsp')">
					</label>
				</div>
			</div>
		...
		<div class="dragLayer" id="smswin">
			<div class="dragHeader">
				...
				<div style="float: right;">
					<label class="more" title="更多" onclick="openMDITab('<%=contextPath %>/erp/mobile_sms/sms_manage.jsp')">
					</label>
				</div>
			</div>
